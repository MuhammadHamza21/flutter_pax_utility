...
import com.mahatech.flutter_pax_printer_utility.Printer.PrinterUtility;
import com.mahatech.flutter_pax_printer_utility.Printer.QRCodeUtil;
import com.mahatech.flutter_pax_printer_utility.ScannerHW.ScannerUtility;
...
public class FlutterPaxPrinterUtilityPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  private static ScannerUtility scannerUtility;
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    scannerUtility = new ScannerUtility(flutterPluginBinding.getApplicationContext());
  }
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    if (call.method.equals("getPlatformVersion")) {
      ...
      String response = scannerUtility.onCreate();
